package com.learn.turtorial1.fragment;
...
public class NewfeedFragment extends Fragment {
    ...
    public void refreshFeed() {
        SFeed feedService = (SFeed) com.learn.turtorial1.library.dmobi.DMobi.getService("SFeed");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sFeed = (SFeed) com.learn.turtorial1.library.dmobi.DMobi.getService(SFeed.class);

        feedAdapter = new FeedAdapter(sFeed.getData());
        recyclerView.setAdapter(feedAdapter);

        completeResponse = new com.learn.turtorial1.library.dmobi.request.Dresponse.Complete() {
            @Override
        ...
        dSwipeRefreshLayout = (DSwipeRefreshLayout) view.findViewById(R.id.swiperefresh);
