package com.learn.turtorial1.customview;
...
/**
 * Created by 09520_000 on 5/19/2015.
 */
...
public class DSwipeRefreshLayout extends ViewGroup {
    ...
    public static final int DEFAULT = DMaterialProgressDrawable.DEFAULT;

    private static final String LOG_TAG = DSwipeRefreshLayout.class.getSimpleName();
    ...
    private DCircleImageView mCircleView;

    // Custom Swipe Refresh Layout
    private DCircleImageView mLoadMoreCircleView;
    ...
    private DMaterialProgressDrawable mProgress;

    // Custom SwipeRefreshLayout
    private DMaterialProgressDrawable mLoadMoreProgress;
    ...
    public void setSize(int size) {
        if (size != DMaterialProgressDrawable.LARGE && size != DMaterialProgressDrawable.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == DMaterialProgressDrawable.LARGE) {
    ...
    public void stopLoadMore() {
        Log.i("Load more", "Stop Load More");
    ...
    private void ensureTarget() {
        ...
        if (mTarget == null) {
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (!child.equals(mCircleView) && !child.equals(mLoadMoreCircleView) && !child.equals(backDrop)) {
                    mTarget = child;
                    initTarget();
                    break;
                }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mLoadMoreCircleView.measure(MeasureSpec.makeMeasureSpec(mCircleWidth, MeasureSpec.EXACTLY),
                MeasureSpec.makeMeasureSpec(mCircleHeight, MeasureSpec.EXACTLY));
