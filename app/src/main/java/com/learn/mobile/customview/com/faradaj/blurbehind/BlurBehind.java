package com.learn.mobile.customview.com.faradaj.blurbehind;
...
import com.learn.mobile.customview.com.faradaj.blurbehind.util.Blur;

/**
 * Created by 09520_000 on 11/29/2015.
 */
public class BlurBehind {
    ...
    private class CacheBlurBehindAndExecuteTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            Bitmap blurredBitmap = Blur.apply(activity, image, blurRadius);
