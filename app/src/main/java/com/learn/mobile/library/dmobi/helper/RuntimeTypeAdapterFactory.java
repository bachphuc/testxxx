...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
    public static final String TAG = RuntimeTypeAdapterFactory.class.getSimpleName();
    ...
    public RuntimeTypeAdapterFactory<T> registerSubtype(Class<? extends T> type) {
        ...
        strType = DUtils.convertClassNameToNormal(strType).toLowerCase();
        return registerSubtype(type, strType);
    }
